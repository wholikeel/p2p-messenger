...
// Automated testing checks Java_com_p2pmessenger_P2pMessengerModule and p2pmessenger
...
// Installer coming from P2pMessengerModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_p2pmessenger_P2pMessengerModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return p2pmessenger::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_p2pmessenger_P2pMessengerModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return p2pmessenger::cleanupRustCrate(*runtime);
}